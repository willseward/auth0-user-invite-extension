...
// Fetch.
export const FETCH_EMAILSETTINGS_CONFIGURATION = 'FETCH_EMAILSETTINGS_CONFIGURATION';
export const FETCH_EMAILSETTINGS_CONFIGURATION_PENDING = 'FETCH_EMAILSETTINGS_CONFIGURATION_PENDING';
export const FETCH_EMAILSETTINGS_CONFIGURATION_REJECTED = 'FETCH_EMAILSETTINGS_CONFIGURATION_REJECTED';
export const FETCH_EMAILSETTINGS_CONFIGURATION_FULFILLED = 'FETCH_EMAILSETTINGS_CONFIGURATION_FULFILLED';

// Save.
export const SAVE_EMAILSETTINGS_CONFIGURATION = 'SAVE_EMAILSETTINGS_CONFIGURATION';
export const SAVE_EMAILSETTINGS_CONFIGURATION_PENDING = 'SAVE_EMAILSETTINGS_CONFIGURATION_PENDING';
export const SAVE_EMAILSETTINGS_CONFIGURATION_REJECTED = 'SAVE_EMAILSETTINGS_CONFIGURATION_REJECTED';
export const SAVE_EMAILSETTINGS_CONFIGURATION_FULFILLED = 'SAVE_EMAILSETTINGS_CONFIGURATION_FULFILLED';
